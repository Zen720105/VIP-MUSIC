...
)  # Example:- https://t.me/Crunchyrol_Anime_In_Hindi_India
SUPPORT_GROUP = getenv(
    "SUPPORT_GROUP", "https://t.me/NIYTODUPORRTCHATT"
...
GITHUB_REPO = getenv("GITHUB_REPO", "https://t.me/queen143np")
...
if PING_IMG_URL:
    if PING_IMG_URL != "https://files.catbox.moe/0hp0vs.jpg":
...
if PLAYLIST_IMG_URL:
    if PLAYLIST_IMG_URL != "https://files.catbox.moe/cj51hz.jpg":
...
if STATS_IMG_URL:
    if STATS_IMG_URL != "https://files.catbox.moe/24of8x.jpg":
